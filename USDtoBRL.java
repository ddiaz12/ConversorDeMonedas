    ...
    public static void convert(double amount) {
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                // Obtener la tasa de cambio de USD a BRL
                double tasaDeCambioBRL = jsonResponse.getAsJsonObject("conversion_rates").get("BRL").getAsDouble();

                // Realizar la conversión de USD a BRL
                double resultadoBRL = amount * tasaDeCambioBRL;

                // Imprimir el resultado
                System.out.println("---------------------");
                System.out.println(amount + " USD equivale a " + resultadoBRL + " BRL.");
                System.out.println("---------------------");
            } else {

    ...
    public static void convert(double amount) {
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                // Obtener la tasa de cambio de USD a BOB
                double tasaDeCambioUSD = jsonResponse.getAsJsonObject("conversion_rates").get("BOB").getAsDouble();

                // Realizar la conversión de USD a BOB
                double resultadoBOB = amount * tasaDeCambioUSD;

                // Imprimir el resultado
                System.out.println("------------------------------------");
                System.out.println(amount + " USD equivale a " + resultadoBOB + " BOB.");
                System.out.println("------------------------------------");
            } else {
